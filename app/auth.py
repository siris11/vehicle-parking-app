...
def login():
    if current_user.is_authenticated:
        ...
        return redirect(url_for('routes.index')) # Or user dashboard: url_for('user_routes.dashboard')
    ...
    if form.validate_on_submit():
        ...
        if not next_page or urlparse(next_page).netloc != '':
            if user.is_admin:
                ...
                next_page = url_for('routes.index') # Or user dashboard: url_for('user_routes.dashboard')
